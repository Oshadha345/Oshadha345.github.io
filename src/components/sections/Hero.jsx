...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative isolate overflow-hidden pt-28 pb-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* right side */}
        <div className="relative z-0 animate-fade-in-up animation-delay-200">
          {/* avatar shell */}
          <div className="relative mx-auto w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
            {/* Glow Effect */}
            <div className="absolute inset-0 z-0 bg-gradient-to-r from-blue-500/30 to-purple-500/30 rounded-full blur-3xl"></div>
            
            {/* Avatar Image */}
            <div className="relative z-10 glass-card rounded-full p-2 animate-float">
              <img
                src={profile.avatar}
                alt={profile.name}
            ...
            {/* Skills Grid */}
            <div className="relative z-30 mt-6 glass-card p-6 rounded-2xl">
